$(function() {
    window.addEventListener("message", function (event) {
        ...
        if (_.NotifyType == "sucesso") {
            ...
            $("<div class='notifyyy'><div class='notify-titulo'><div class='notify-typee'>Aviso Administração</div><div class='notify-rr'></div><div class='notify-textt'>"+_.NotifyString+"</div></div></div>").appendTo("#container").hide().fadeIn(750).delay(15000).fadeOut(750);
